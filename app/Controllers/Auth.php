        ...
        if ($this->request->getVar('saya_siswa') != null) {
            ...
            $this->email->setMessage('
                <div style="color: #000; padding: 10px;">
                    ...
                    <small style="color: #000;">Sekolah Islam Rasa Pesantren</small>
                    <br>
                    <p style="font-family: `Segoe UI`, Tahoma, Geneva, Verdana, sans-serif; color: #000;">Hallo ' . $this->request->getVar('nama') . ' <br>
                        <span style="color: #000;">Anda telah Melakukan Pendaftaran ke SMAIT Almaka sebagai SISWA. Silahkan lakukan aktivasi dengan cara mengklik tombol aktivasi</span><br>
                        </p>
            ...
            $config['SMTPUser'] = 'diazms190@gmail.com';
            $config['SMTPPass'] = 'jgyfzbbcgigoypae';
            $config['SMTPPort'] = 465;
            ...
            $this->email->setFrom('diazms190@gmail.com', 'SMAIT ALMAKA');
            $this->email->setTo($email);
            ...
            $this->email->setMessage('
                <div style="color: #000; padding: 10px;">
                    ...
                    <br>
                    <p style="font-family: `Segoe UI`, Tahoma, Geneva, Verdana, sans-serif; color: #000;">Hallo ' . $this->request->getVar('nama') . ' <br>
                        <span style="color: #000;">Anda telah Melakukan Pendaftaran ke SMAIT ALMAKA sebagai GURU. Silahkan lakukan aktivasi dengan cara mengklik tombol aktivasi</span><br>
                    </p>
                    <a href="' . base_url() . '/auth/verify?email=' . $email . '&token=' . $token .  '" style="display: inline-block; width: 100px; height: 30px; background: #1C3FAA; color: #fff; text-decoration: none; border-radius: 5px; text-align: center; line-height: 30px; font-family: `Segoe UI`, Tahoma, Geneva, Verdana, sans-serif;">
                        aktivasi        
                    </a>
