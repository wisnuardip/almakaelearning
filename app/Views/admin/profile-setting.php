                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <form action="<?= base_url('app/setting_email'); ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="n-chk">
                                    <label class="new-control new-radio radio-classic-primary">
                                        <input type="radio" class="new-control-input" name="notif_tugas" value="1" <?= ($smtp->notif_tugas == 1) ? 'checked' : ''; ?>>
                                        <span class="new-control-indicator"></span>On
                                    </label>
                                </div>
                                <div class="n-chk">
                                    <label class="new-control new-radio radio-classic-danger">
                                        <input type="radio" class="new-control-input" name="notif_tugas" value="0" <?= ($smtp->notif_tugas == 0) ? 'checked' : ''; ?>>
                                        <span class="new-control-indicator"></span>OF
                                    </label>
                                </div>
                            </div>
