...
<div id="content" class="main-content">
                ...
                <div class="user-profile layout-spacing">
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="text-center user-info">
                            <img src="<?= base_url('assets/app-assets/user/') . '/' . $guru->avatar; ?>" class="img-user" alt="avatar" style="width: 125px; height: 125px;">
                            <p class=""><?= $guru->nama_guru; ?></p>
                        </div>
                        <div class="user-info-list" style="margin-top: -10px;">
                            <div class="text-center">
                                <p>Guru SMAIT ALMAKA</p>
                                <ul class="contacts-block list-unstyled" style="margin-top: -5px;">
                                    <li class="contacts-block__item">
                                        ...
                                        </svg><br><?= date('d-M-Y', $guru->date_created); ?>
                                    </li>
                                    <li class="contacts-block__item">
            ...
            <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                ...
                <div class="skills layout-spacing ">
                    <div class="widget-content widget-content-area">
                        ...
                        <form action="<?= base_url('guru/edit_profile'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="skills layout-spacing">
                    <div class="widget-content widget-content-area">
                        ...
                        <form action="<?= base_url('guru/edit_password'); ?>" method="post">
                            <div class="form-group">
    ...
    <div class="footer-wrapper">
        <div class="footer-section f-section-1">
            <p class="">Copyright © 2023 SMAIT Almaka, All rights reserved.</p>
        </div>
