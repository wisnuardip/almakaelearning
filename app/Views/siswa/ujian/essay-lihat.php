...
<div id="content" class="main-content">
                                        ...
                                        <div class="widget p-3 mt-3">
                                            ...
                                            <div class="widget-content mt-3" style="position: relative;">
                                                ...
                                                <div class="green-radio color-green">
                                                    <textarea name="<?= $soal->id_essay_detail; ?>" data-alternateName="<?= $soal->id_essay_detail; ?>" data-alternateValue="<?= $no; ?>" id="soal<?= $no; ?>-<?= $soal->id_essay_detail; ?>" data-essay_siswa="<?= $jawaban_siswa->id_essay_siswa; ?>" data-noSoal="<?= $no; ?>" class="form-control" placeholder="tuliskan jawaban..."><?php if ($jawaban_siswa->jawaban !== null) {
                                    ...
                                    <div class="question <?= $soal_hidden; ?> question-<?= $no; ?>" data-question="<?= $no; ?>">
                                        ...
                                        <div class="widget p-3 mt-3">
                                            ...
                                            <div class="widget-content mt-3" style="position: relative;">
                                                <div class="alert alert-danger hidden"></div>
                                                <div class="green-radio color-green">
                                                    <textarea name="<?= $soal->id_essay_detail; ?>" data-alternateName="<?= $soal->id_essay_detail; ?>" data-alternateValue="<?= $no; ?>" id="soal<?= $no; ?>-<?= $soal->id_essay_detail; ?>" data-essay_siswa="<?= $jawaban_siswa->id_essay_siswa; ?>" data-noSoal="<?= $no; ?>" class="form-control" placeholder="Tidak Dijawab" readonly><?php if ($jawaban_siswa->jawaban !== null) {
                                                                                                                                                                                                                                                                                                                                                                                                echo $jawaban_siswa->jawaban;
                                                                                                                                                                                                                                                                                                                                                                                            } ?></textarea>
    ...
    <div class="footer-wrapper">
        <div class="footer-section f-section-1">
            <p class="">Copyright © 2023 SMAIT Almaka</p>
        </div>
        <div class="footer-section f-section-2">
            <p class="">SMAIT ALMAKA</p>
        </div>
    </div>
</div>
<!--  END CONTENT AREA  -->
